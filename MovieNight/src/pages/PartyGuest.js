...
import { ThumbsUp, ThumbsDown, Plus, Clapperboard, MapPin, Clock } from 'lucide-react';
...
export default function PartyGuest() {
  ...
  const [movies, setMovies] = useState([
    { id: 1, name: 'Sample Movie', category: 'Sci-Fi', rating: '8.8', runtime: '2h 28m', imdbLink: '', votes: { up: 3, down: 1 } },
  ]);

  const [showTimes, setShowTimes] = useState([
    { id: 1, date: '2025-11-26', time: '19:00', votes: { up: 4, down: 1 } },
  ]);
